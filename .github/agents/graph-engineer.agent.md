...
- **These modules are pure.** No I/O, no network, no `process.env`, no Octokit, no Anthropic SDK. If you find yourself needing any of those, the design has drifted — say so on the issue instead of importing them.
