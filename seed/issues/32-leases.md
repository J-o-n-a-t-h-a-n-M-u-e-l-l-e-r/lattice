...
`claim_next_issue({ agent_id, lease_minutes, area })` — atomically claim the highest-ranked unclaimed ready issue, returning the issue, a lease expiry, a suggested base ref, and a **briefing** naming what it unblocks and what those dependents need from it.
...
The briefing is where the graph earns its keep: *"you are unblocking #19 and #23, and #19 consumes the type you export here"* is knowledge the agent would otherwise have to rediscover, or more likely never discover.
...
- [ ] The briefing names dependents and what they consume
